...
public class AtributosDeclaradosTest {
	...
	public void testAtributosTransporte() {
		...
		assertTrue("La clase Transporte no es abstracta", 
				Modifier.isAbstract(Transporte.class.getModifiers()));
	...
	public void testAtributosFurgoneta() {
		...
		assertTrue("La clase Furgoneta no es abstracta", 
				Modifier.isAbstract(Furgoneta.class.getModifiers()));
	...
	public void testAtributosFurgonetaPropia() {
		...
		String[] attrNames = {"velocidadMedia", "EUROS_P_HORA"};
